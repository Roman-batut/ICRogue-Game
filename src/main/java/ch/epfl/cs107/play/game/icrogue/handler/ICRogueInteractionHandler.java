...
public interface ICRogueInteractionHandler extends AreaInteractionVisitor{
    ...
    default void interactWith(Marchand marchand, boolean isCellInteraction) {
    }

    default void interactWith(CoeurStand coeurStand, boolean isCellInteraction) {
    }

    default void interactWith(BoostDmgStand boostDmgStand, boolean isCellInteraction) {
    }
